#ifndef __SAMPLE_VIRVI2VENC_H__
#define __SAMPLE_VIRVI2VENC_H__
...
typedef struct Virvi2Venc_Config
{
    ...
    int mReqIDREnable;
    int mDynamicSetVeRefFrameLbcModeEnable;
}VIRVI2VENC_CONFIG_S;

typedef struct SAMPLE_VIRVI2VENC_S
{
    VIRVI2VENC_CONFIG_S mConfigPara;
...
#endif //#define __SAMPLE_VIRVI2VENC_H__
