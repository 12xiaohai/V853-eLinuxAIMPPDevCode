...
typedef enum RECODERWRITECOMMANDS
{
	...
	SET_STREAM_CALLBACK,
    SET_FILE_REPAIR_FLAG,
    SET_ADD_REPAIR_INFO_FLAG,

    SET_FILE_REPAIR_INTERVAL,
...
{
	// video
	int mVideoInfoValidNum;
	MediaVideoInfo mMediaVideoInfo[MAX_VIDEO_TRACK_COUNT];
	/*
    int nHeight;
	int nWidth;
	int uVideoFrmRate;  // *1000
