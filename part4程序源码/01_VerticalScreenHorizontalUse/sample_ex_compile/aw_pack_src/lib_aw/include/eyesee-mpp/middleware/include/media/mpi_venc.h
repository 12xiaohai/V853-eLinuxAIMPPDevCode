...
/**
 * In QPMAP mode, please use the Venc Lib interface directly.
 * The mpi interface is no longer supported.
 */
...
/**
* set Venc component id
*/
//ERRORTYPE AW_MPI_VENC_SetVencId(VENC_CHN VeChn, int VencId);
