...
typedef struct VI_CROP_CFG_S
{
    BOOL bEnable;    /* Crop region enable */
    RECT_S  Rect;    /* Crop region. */
} VI_CROP_CFG_S;
...
typedef struct awVI_ATTR_S {
    ...
    enum dma_buffer_num mOnlineShareBufNum; /* only for online. Number of share buffers of CSI and VE, support 1/2.*/
