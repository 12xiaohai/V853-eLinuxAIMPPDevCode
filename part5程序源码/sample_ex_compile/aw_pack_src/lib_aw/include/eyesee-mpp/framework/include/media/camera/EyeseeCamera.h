...
public:
    ...
    /**
     * @brief change video layer, app must guarantee that new video layer and its mpi_vo exit.
     * @param chnId the channel to be set.
     * @param hlay display surface.
     * @return 0 if channel closed successfully, otherwise return error code.
     */
     ...
     * @brief get current Adas params from designated channel.
     * @param chnId the channel opened.
     * @param pParamDTCA Detect, Track, Classify, Analysis parameters. can set to NULL, indicate don't want to get its value.
     * @param pParamCLBR calibration parameters, can set to NULL, indicate don't want to get its value.
     * @return NO_ERROR if successful.
    ...
    /**
     * Adas Object Detection
     * @brief set adas params to designated channel. Call this method before start MOD detect.
     * @param chnId the channel opened.
     * @param pParamDTCA Detect, Track, Classify, Analysis parameters. It can be set to NULL, indicate don't want to set its value.
     * @param pParamCLBR calibration parameters. It can be set to NULL, indicate don't want to set its value.
     * @return NO_ERROR if successful.
    ...
    /**
     * Adas Object Detection
     * @brief get current Adas in callback params from designated channel.
     * @param chnId the channel opened.
     * @param pParamDTCA Detect, Track, Classify, Analysis parameters. can set to NULL, indicate don't want to get its value.
     * @param pParamCLBR calibration parameters, can set to NULL, indicate don't want to get its value.
     * @return NO_ERROR if successful.
    ...
    /**
     * Adas Object Detection
     * @brief set adas in callback params to designated channel. Call this method before start ADAS detect.
     * @param chnId the channel opened.
     * @param pParamDTCA Detect, Track, Classify, Analysis parameters. It can be set to NULL, indicate don't want to set its value.
     * @param pParamCLBR calibration parameters. It can be set to NULL, indicate don't want to set its value.
     * @return NO_ERROR if successful.
    ...
    /**
     * @brief start Adas Object Detection. Call this method after startChannel().
     * @param chnId the channel opened.
     * @return NO_ERROR if successful.
     */
    ...
    /**
     * @brief stop Adas Object Detection. Call this method before stopChannel().
     * @param chnId the channel opened.
     * @return NO_ERROR if successful.
     */
...
//    status_t OSDOnOff(int chnId, bool bOnOff);
    ...
    public:
        ...
        virtual void            increaseBufRef(int chnId, VIDEO_FRAME_BUFFER_S *pBuf);
    private:
    ...
    /**
     * Callback interface used to supply AdasObjectDetection data from one camera channel.
     */
    class AdasDataCallback
    {
    public:
        AdasDataCallback(){}
        virtual ~AdasDataCallback(){}
        /**
         * Called when vda data is available during frame capture.
         * The format of the data is AW_AI_ADAS_DETECT_R.
         *
         * @param chnId camera channel.
         * @param data ADAS result struct.
         * @param camera the Camera service object
         */
        virtual void onAdasOutData(int chnId, AW_AI_ADAS_DETECT_R_ *p_sResult,EyeseeCamera* pCamera) = 0;
        virtual void onAdasOutData_v2(int chnId, AW_AI_ADAS_DETECT_R__v2 *p_sResult,EyeseeCamera* pCamera) = 0;
    };
    /**
     * <p>Installs a callback to be invoked for every ADAS data which coming when generated.
     * The callback will be repeatedly called for as long as MOD detection is active.  
     * This method can be called at any time, even while MOD detect is live.  
     * Any other ADAS callbacks are overridden.</p>
     *
     * <p>If you are using the ADAS data, data will be valid during onMODData() is called.
     * After called, data will be invalid.</p>
     *
     * @param pCb a callback object that receives a ADAS data object,
     *     or null to stop receiving callbacks.
     */
    void setAdasDataCallback(AdasDataCallback *pCb);
...
private:
    ...
    AdasDataCallback *mpAdasDataCallback;
